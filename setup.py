...
setup(
    ...
    data_files=[
      ...
      ('/etc/toggle/style/DarkTheme', [
        'style/DarkTheme/style.css',
        'style/DarkTheme/ui_800x480.json',
        'style/DarkTheme/ui_1920x1080.json',
        'style/DarkTheme/arrow_128.png',
        'style/DarkTheme/arrow_disabled_128.png',
        'style/DarkTheme/cancel_128.png',
        'style/DarkTheme/cancel_disabled_128.png',
        'style/DarkTheme/connected_128.png',
        'style/DarkTheme/disconnected_128.png',
        'style/DarkTheme/e.png',
        'style/DarkTheme/h.png',
        'style/DarkTheme/z.png',
        'style/DarkTheme/heartbeat_128.png',
        'style/DarkTheme/heater_bed_cold_128.png',
        'style/DarkTheme/heater_bed_hot_128.png',
        'style/DarkTheme/heater_bed_heating_128.png',
        'style/DarkTheme/heater_cold_128.png',
        'style/DarkTheme/heater_hot_128.png',
        'style/DarkTheme/heater_heating_128.png',
        'style/DarkTheme/home.png',
        'style/DarkTheme/jog_128.png',
        'style/DarkTheme/loading_128.png',
        'style/DarkTheme/pause_128.png',
        'style/DarkTheme/pause_disabled_128.png',
        'style/DarkTheme/play_128.png',
        'style/DarkTheme/play_disabled_128.png',
        'style/DarkTheme/print_128.png',
        'style/DarkTheme/temperature_128.png',
        'style/DarkTheme/travel_0.1_128.png',
        'style/DarkTheme/travel_1_128.png',
        'style/DarkTheme/travel_10_128.png',
        'style/DarkTheme/travel_100_128.png',
        'style/DarkTheme/Toggle_splash_900.png',
        'style/DarkTheme/Toggle_splash_400.png',
        'style/DarkTheme/pointer.png',
        'style/DarkTheme/fan_128.png',
        'style/DarkTheme/fandisable_128.png',
        'style/DarkTheme/motorsoff_128.png',
        'style/DarkTheme/settings_128.png',
        'style/DarkTheme/network_128.png',
        'style/DarkTheme/wifi_128.png',
        'style/DarkTheme/slicer_128.png'
        ]),
